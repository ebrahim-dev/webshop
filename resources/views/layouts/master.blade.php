			...
			<div class="row">
				<div class="col-lg-12 col-sm-12 text-center">
					<div class="main-menu-wrap">
						...
						<div class="site-logo">
							<a href="/">
								<img src="{{ asset('assets\img\logo\20240326_131303_0000.png') }} " alt="" width="50%">
							</a>
						</div>
						<!-- logo -->
					...
					<div class="col-md-12 col-lg-7 offset-lg-1 offset-xl-0">
						<div class="hero-text">
							<div class="hero-text-tablecell">
								...
								<h1>For all times</h1>
								<div class="hero-btns">
									<a href="{{ route('products') }}" class="boxed-btn">Visit Products</a>
									<a href="{{ route('categories') }}" class="bordered-btn">Discover the categories</a>
								</div>
							</div>
						</div>
					</div>
...
<form action="{{ route('changeLanguage','nl') }}" method="post">
    @csrf
