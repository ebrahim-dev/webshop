    ...
    <tbody>
        @foreach ($categories as $item)
            <tr>
                ...
                <td> <a href="/removecategory/{{ $item->id }}" class="btn btn-danger "><i class="fas fa-trash"></i>Delete</a>
                    <a href="/editcategory/{{ $item->id }}" class="btn btn-primary "><i class="fas fa-pen"></i>Edit</a>
                </td>
